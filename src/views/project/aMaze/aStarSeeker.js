import SeekerNode from './seekerNode'
export default class AStarSeeker{
    constructor(sk, alwaysShowPath = false, diagonalsEnabled = false){
        this.grid = undefined;
    ...
    heuristic(a, b){
        ...
        let h = this.sk.dist(a.i, a.j, b.i, b.j)*10
        return h
    }
    setGrid(grid, w, h){
        this.grid = grid;
